          ...
          <Row>
            ...
            <Col xs={6} md={3} lg={2}>
              <About
                ...
                role={'VP Internal'}
                linkedin={
                  'https://linkedin.com/in/alexandershih2022/'
                }
              />
            </Col>
            <Col xs={6} md={3} lg={2}>
          ...
          <Row>
            ...
            <Col xs={6} md={3} lg={2}>
              <About
                ...
                role={'Developer'}
                linkedin={
                  'https://linkedin.com/in/jordan-janakievski/'
                }
              />
            </Col>
            <Col xs={6} md={3} lg={2}>
            ...
            <Col xs={6} md={3} lg={2}>
              <About
                ...
                role={'Developer'}
                linkedin={
                  'https://www.linkedin.com/in/mishaal-kandapath/'
                }
              />
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col xs={6} md={3} lg={2}>
              <About
                ...
                role={'Developer'}
                linkedin={
                  'https://linkedin.com/in/sakina-gadriwala-14b779156/'
                }
              />
            </Col>
            <Col xs={6} md={3} lg={2}>
