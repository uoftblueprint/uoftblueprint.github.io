        ...
        <Row>
          <Col>
            <ValueCard image={missionIcon} title={'Mission First'}>
              <p>
                We will always prioritize the mission first. Our main priority is doing professional
                work for social good and public welfare.
              </p>
            </ValueCard>
          </Col>
          <Col>
            <ValueCard image={innovationIcon} title={'Innovation'}>
              <p>
                We will continue to push the boundaries by combining the expertise of our developers
                and the nonprofit to guarantee the best possible solution.
              </p>
            </ValueCard>
          </Col>
          <Col>
          ...
          <Row className='align-items-center'>
            <Col className='text-left' xs={12} sm={6}>
              <div id='contact-text'>
                <h2>Contact Us!</h2>
                <p>
                  We are looking for nonprofits who are in need of technological solutions, as well
                  as partners interested in supporting us and our cause.
                </p>
              </div>
            </Col>
            <Col xs={12} sm={6}>
