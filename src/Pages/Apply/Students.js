        ...
        <Row>
          <Col md="auto">
            <div style={{ paddingLeft: '5%', paddingTop: '1.5em', paddingBottom: '2em' }}>
              ...
              <div style={{
                minWidth: '30vw', width: '35em', maxWidth: '75vw', paddingBottom: '1em',
              }}
              >
                <h4
                  style={{
                    padding: '25px 0 5px 0', 'font-size': '2rem', color: '#FFFFFF', fontWeight: '200',
                  }}
              ...
              <div>
                ...
                <button>
                  <Link activeClass="active" to="requirements" spy smooth duration={1000} style={{ padding: '25px 0 5px 0', 'font-size': '1.2rem', color: '#FFFFFF' }}>
                    What we look for
                  </Link>
                </button>
              </div>
          ...
          <Col md="5" style={{ paddingLeft: '4em' }}>
            <img
              ...
              src={team}
              style={{
                paddingTop: '4em', paddingBottom: '4em', width: '30em', height: 'auto',
              }}
            />
          </Col>
        </Row>
    ...
    <Container fluid="md" style={{ paddingTop: '4rem', paddingBottom: '8em' }}>
      <Row>
        { window.innerWidth < 480 ? null : (
          <Col md="3">
            <img
              src={standing}
              style={{
                paddingTop: '4em', paddingBottom: '4em', width: '15em', height: 'auto',
              }}
            />
          </Col>
        )}
        <Col md="8">
          ...
          <p style={{
            paddingTop: '2em', color: 'grey', fontSize: '1.4em', fontWeight: '400',
          }}
          >
